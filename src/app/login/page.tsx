        ...
        <div className="w-full max-w-md">
          ...
          <Card className="shadow-xl border-0">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    required
                  />
                  <button type="button" className="cursor-pointer absolute right-3 top-4 h-4 w-4 text-gray-400 hover:text-gray-600">
            ...
            <CardFooter className="flex flex-col space-y-4 pt-6">
              {/* Login Button */}
              <Button formAction={login} className="w-full h-12 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 cursor-pointer">
                ログイン
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button variant="outline" className="h-12 bg-transparent cursor-pointer">
                ...
                <Button formAction={signInWithGithub} variant="outline" className="h-12 bg-transparent cursor-pointer">

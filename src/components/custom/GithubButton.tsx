...
export default function GithubButton() {
    return (
        <div className="bg-transparent hover:bg-gray-100 border border-gray-300 rounded-md">
            <button onClick={signInWithGithub} className="w-full h-full flex items-center justify-center p-2 cursor-pointer">
                 {/* Githubアイコン */}

...
export default function EllipsisMenu({ postId, isOwner = false }: EllipsisMenuProps) {
                    ...
                    <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 bg-white rounded-lg shadow-2xl border border-gray-200 p-6 max-w-sm w-full mx-4">
                        ...
                        <div className="flex space-x-3">
                            ...
                            <button 
                                ...
                                className="cursor-pointer flex-1 bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-md transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                                disabled={isDeleting}
                            >
